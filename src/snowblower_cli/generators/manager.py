...
"""
    ...
    def write_outputs(self) -> bool:
        ...
        if self.output.get("shell-tools"):
            # AI: Apply the file converter here. At the top of any file generated add a comment that the file is auto generated by snowblower.
            shell - tools.aider
