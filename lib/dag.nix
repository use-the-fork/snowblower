# From nvf: https://github.com/NotAShelf/nvf/blob/main/lib/dag.nix
# and home-manager: https://github.com/nix-community/home-manager/blob/master/modules/lib/dag.nix
...
{lib}: let
  ...
  inherit (lib.sbl.dag) empty isEntry entryBetween entryAfter entriesBetween entryAnywhere topoSort;
in {
  empty = {};
